...
// Stub implementations for remaining messages to complete compilation

std::vector<uint8_t> AcceptChannelMessage::Serialize() const { return {}; }
Result<AcceptChannelMessage> AcceptChannelMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<AcceptChannelMessage>::Error("Not implemented");
}

std::vector<uint8_t> FundingCreatedMessage::Serialize() const { return {}; }
Result<FundingCreatedMessage> FundingCreatedMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<FundingCreatedMessage>::Error("Not implemented");
}

std::vector<uint8_t> FundingSignedMessage::Serialize() const { return {}; }
Result<FundingSignedMessage> FundingSignedMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<FundingSignedMessage>::Error("Not implemented");
}

std::vector<uint8_t> FundingLockedMessage::Serialize() const { return {}; }
Result<FundingLockedMessage> FundingLockedMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<FundingLockedMessage>::Error("Not implemented");
}

std::vector<uint8_t> ShutdownMessage::Serialize() const { return {}; }
Result<ShutdownMessage> ShutdownMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<ShutdownMessage>::Error("Not implemented");
}

std::vector<uint8_t> ClosingSignedMessage::Serialize() const { return {}; }
Result<ClosingSignedMessage> ClosingSignedMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<ClosingSignedMessage>::Error("Not implemented");
}

std::vector<uint8_t> UpdateFailHTLCMessage::Serialize() const { return {}; }
Result<UpdateFailHTLCMessage> UpdateFailHTLCMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<UpdateFailHTLCMessage>::Error("Not implemented");
}

std::vector<uint8_t> UpdateFeeMessage::Serialize() const { return {}; }
Result<UpdateFeeMessage> UpdateFeeMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<UpdateFeeMessage>::Error("Not implemented");
}

std::vector<uint8_t> UpdateFailMalformedHTLCMessage::Serialize() const { return {}; }
Result<UpdateFailMalformedHTLCMessage> UpdateFailMalformedHTLCMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<UpdateFailMalformedHTLCMessage>::Error("Not implemented");
}

std::vector<uint8_t> ChannelReestablishMessage::Serialize() const { return {}; }
Result<ChannelReestablishMessage> ChannelReestablishMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<ChannelReestablishMessage>::Error("Not implemented");
}

std::vector<uint8_t> AnnouncementSignaturesMessage::Serialize() const { return {}; }
Result<AnnouncementSignaturesMessage> AnnouncementSignaturesMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<AnnouncementSignaturesMessage>::Error("Not implemented");
}

std::vector<uint8_t> ChannelUpdateMessage::Serialize() const { return {}; }
Result<ChannelUpdateMessage> ChannelUpdateMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<ChannelUpdateMessage>::Error("Not implemented");
}

std::vector<uint8_t> QueryShortChannelIdsMessage::Serialize() const { return {}; }
Result<QueryShortChannelIdsMessage> QueryShortChannelIdsMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<QueryShortChannelIdsMessage>::Error("Not implemented");
}

std::vector<uint8_t> ReplyShortChannelIdsEndMessage::Serialize() const { return {}; }
Result<ReplyShortChannelIdsEndMessage> ReplyShortChannelIdsEndMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<ReplyShortChannelIdsEndMessage>::Error("Not implemented");
}

std::vector<uint8_t> QueryChannelRangeMessage::Serialize() const { return {}; }
Result<QueryChannelRangeMessage> QueryChannelRangeMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<QueryChannelRangeMessage>::Error("Not implemented");
}

std::vector<uint8_t> ReplyChannelRangeMessage::Serialize() const { return {}; }
Result<ReplyChannelRangeMessage> ReplyChannelRangeMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<ReplyChannelRangeMessage>::Error("Not implemented");
}

std::vector<uint8_t> GossipTimestampFilterMessage::Serialize() const { return {}; }
Result<GossipTimestampFilterMessage> GossipTimestampFilterMessage::Deserialize(const std::vector<uint8_t>&) {
    return Result<GossipTimestampFilterMessage>::Error("Not implemented");
}
