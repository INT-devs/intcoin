...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        const std::vector<std::string> seed_nodes = {
            "seed-us.international-coin.org:9333",  // US node
            "seed-uk.international-coin.org:9333",  // UK node
            "2nrhdp7i4dricaf362hwnajj27lscbmimggvjetwjhuwgtdnfcurxzyd.onion:9333"  // Tor node
        };

        for (const auto& seed : seed_nodes) {
            log_message(config, "Adding seed node: " + seed);
